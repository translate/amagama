...
project = u'amaGama'
copyright = u'2012-2014, Translate.org.za'
...
latex_documents = [
  ('index', 'Amagama.tex', u'amaGama Documentation',
...
man_pages = [
    ('index', 'amagama', u'amaGama Documentation',
...
texinfo_documents = [
  ('index', 'amagama', u'amaGama Documentation',
   u'Translate.org.za', 'amaGama', 'Translation Memory server.',
   'Miscellaneous'),
]
